        ...
        <body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
            ...
            <section class="bg-white py-8">
                ...
                <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
                    ...
                    <nav id="store" class="w-full z-30 top-0 px-6 py-1">
                        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">
                            ...
                            <div class="flex items-center" id="store-nav-content">
                                <router-link to="/addcart" class="pl-3 inline-block no-underline hover:text-black" >
                    ...
                    <div v-for="item in products" :key="item" class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                        <a href="#">
                            <img class="hover:grow hover:shadow-lg"
                                src="https://images.unsplash.com/photo-1551431009-a802eeec77b1?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&h=400&q=80">
                            <div class="pt-3 flex items-center justify-between">
